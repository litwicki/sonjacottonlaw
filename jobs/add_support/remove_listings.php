...
<a href="http://www.sonjacottonlaw.com/jobs/add_support/remove.php">here</a>.</font></p>
TOTHEEND6;
if($err_flag)
{
...
{
	echo "<meta HTTP-EQUIV=\"REFRESH\" content=\"7; url=http://www.sonjacottonlaw.com/jobs/add_support/remove.php\">\n";
}
echo "</body>\n</html>\n";
